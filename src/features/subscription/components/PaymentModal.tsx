...
import { requestSubscriptionPayment, executePayment, generateOrderId } from "@/features/subscription/api/payment";
import { getPlanById } from "@/shared/constants/subscriptionPlans";
    ...
    <div className="payment-modal-overlay" onClick={onClose}>
      <div className="payment-modal" onClick={(e) => e.stopPropagation()}>
        <div className="payment-modal-header">
          <h2>{PORTFOLIO_SCOPE.subscription.demoBadge}</h2>
        ...
        <div className="payment-modal-content">
          <p className="payment-demo-notice">{PORTFOLIO_SCOPE.subscription.subtitle}</p>
          {plan && (
