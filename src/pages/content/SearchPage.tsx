...
import { fetchPeopleSearch, fetchSearchResults } from "@/services/tmdb";
...
export default function SearchPage() {
  ...
  const [rawMovieResults, setRawMovieResults] = useState<any[]>([]);
  const [rawTvResults, setRawTvResults] = useState<any[]>([]);
